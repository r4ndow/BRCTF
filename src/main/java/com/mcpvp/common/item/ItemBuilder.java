...
public class ItemBuilder implements Cloneable {
	...
	public ItemBuilder color(DyeColor color) {
		switch (item.getType()) {
			...
			case CARPET:
			case STAINED_GLASS:
			case STAINED_GLASS_PANE: item.setDurability(color.getData()); break;
			case INK_SACK:
			case STAINED_CLAY:
			case CLAY: item.setDurability(color.getDyeData()); break;
			case LEATHER_HELMET:
			case LEATHER_CHESTPLATE:
			case LEATHER_LEGGINGS:
			case LEATHER_BOOTS: return color(color.getColor());
			case GLASS: return type(Material.STAINED_GLASS).color(color);
			case THIN_GLASS: return type(Material.STAINED_GLASS_PANE).color(color);
			default: new Exception("Attempted to color a non-colorable item").printStackTrace();
		}
		return this;
	}
